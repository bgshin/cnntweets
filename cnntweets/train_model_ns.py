...
if __name__ == "__main__":
    ...
    parser.add_argument('--lexnumfilters', default=8, type=int)
    ...
    parser.add_argument('--trainable', default='static', choices=['static', 'nonstatic'],
                        type=str)  # w2v, w2vlex, attention
    parser.add_argument('--model', default='w2vstatic', choices=['w2v', 'w2vrt', 'w2vlex', 'w2vrtlex', 'w2vstatic', 'attention'],
                        type=str)  # w2v, w2vlex, attention
